...
decision(f"The next day your {bossName} asks you to add a data tracking feature in their app. Do you:", ["Implement the feature and add even more privacy invading features", "Implement it reluctantly.", f"Refuse to implement it and tell {bossName} that the feature that you are implementing is illegal in the EU."], [["You add the feature enthusiastically, and add some other collection features. Some activists notice what has been added, and your company is soon in legal trouble.", "rep", -20], ["You reluctantly add the feature, knowing what you are doing is unethical, and try to neuter the collection as much as possible.", "rep", -10], [f"{bossName} thanks you for notifying about the illegal nature of the feature, and immediately stops collection of user data.", "rep", 10]])
print("Commonly today, many apps are unethically collecting data from users who do not know. This mass collection violates the users privacy, and leads to companies having a full detailed picture on its users lives. Avoid purposefully adding these features in, and try to spread awareness about any data collection you notice in apps that you use. ")
print("----------------------------------------")
